...
{
	[DataContract]
	[FlexJamStruct(Name="JamCliPetitionInfo", Version=28333852)]
	public class JamCliPetitionInfo
	{
		[DataMember(Name="m_allowedClasses")]
		...
		[DataMember(Name="m_allowedGender")]
		...
		[DataMember(Name="m_allowedGuildID")]
		...
		[DataMember(Name="m_allowedMaxLevel")]
		...
		[DataMember(Name="m_allowedMinLevel")]
		...
		[DataMember(Name="m_allowedRaces")]
		...
		[DataMember(Name="m_maxSignatures")]
		...
		[DataMember(Name="m_minSignatures")]
