...
namespace Newtonsoft.Json
{
	public abstract class JsonWriter : IDisposable
	{
		...
		static JsonWriter()
		{
			JsonWriter.stateArray = new JsonWriter.State[][] { new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-88821E1DF26D78EB18754B6C63B782777B7168F7").FieldHandle }, new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-E59613C63D9245F8B2CF85740BCAEDBBF24B0851").FieldHandle }, new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-162A7A46BCD84A244E3F402C23AB0DBF2624532C").FieldHandle }, new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-2BE616D9E50D27B7FFF12AA0CD2B09D8F53BE4C9").FieldHandle }, new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-5E4A22E3EAE42CEF4AFC0C6280B473C9A110DB2C").FieldHandle }, new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-0A0D5B5AA815BDD0017F22ADA6671FAFFA4B77EA").FieldHandle }, new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-0A0D5B5AA815BDD0017F22ADA6671FAFFA4B77EA").FieldHandle }, new JsonWriter.State[] { typeof(<PrivateImplementationDetails>).GetField("$field-E0E6D7E415DD8962026D3157A5FB8B7C3B4B3C50").FieldHandle } };
		}
