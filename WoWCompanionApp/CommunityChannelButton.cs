...
namespace WoWCompanionApp
{
	public class CommunityChannelButton : MonoBehaviour
	{
		...
		private WoWCompanionApp.Community m_community;

		private Action<CommunityChannelButton> m_selectAction;

		public WoWCompanionApp.Community Community
		{
			get
			{
		...
		public void SetCommunityInfo(WoWCompanionApp.Community community, CommunityStream stream)
		{
