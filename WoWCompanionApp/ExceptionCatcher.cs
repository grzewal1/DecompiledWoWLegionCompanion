...
namespace WoWCompanionApp
{
	public class ExceptionCatcher : MonoBehaviour
	{
		...
		{
			this.exceptionPanel.gameObject.SetActive(true);
			FileStream fileStream = new FileStream(string.Concat(Application.persistentDataPath, "/exceptions.log"), FileMode.OpenOrCreate);
			StreamReader streamReader = new StreamReader(fileStream);
			string end = streamReader.ReadToEnd();
			streamReader.Close();
			fileStream.Close();
			this.exceptionPanel.SetExceptionText(end);
		}
