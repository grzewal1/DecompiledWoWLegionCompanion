	...
	public class UiAnimation : MonoBehaviour
	{
		...
		public class UiScale : UiAnimation.UiAnimElement
		{
			...
			public override void Update(float elapsedTime, float maxTime, bool reverse)
			{
				...
				vector3.x = this.m_fromScaleX + (this.m_toScaleX - this.m_fromScaleX) * unitProgress;
				vector3.y = this.m_fromScaleY + (this.m_toScaleY - this.m_fromScaleY) * unitProgress;
				vector3.z = 1f;
				((UiAnimation.UiTexture)this.m_texture).m_image.transform.localScale = vector3;
			}
		}
