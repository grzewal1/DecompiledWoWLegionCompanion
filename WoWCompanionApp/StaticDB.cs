...
namespace WoWCompanionApp
{
	public class StaticDB : Singleton<StaticDB>
	{
		...
		{
			return StaticDB.itemSubClassDB.GetRecordsByParentID(classID).FirstOrDefault<ItemSubClassRec>((ItemSubClassRec subClassRec) => subClassRec.SubClassID == subClassID);
		}
		...
		{
			return (Singleton<StaticDB>.instance == null ? false : Singleton<StaticDB>.instance.m_mobileStringsDB != null);
		}
	}
}