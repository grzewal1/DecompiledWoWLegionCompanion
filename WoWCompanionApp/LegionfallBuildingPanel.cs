...
namespace WoWCompanionApp
{
	...
	{
		public readonly static string LegionfallBundleName;
		...
		static LegionfallBuildingPanel()
		{
			LegionfallBuildingPanel.LegionfallBundleName = "legionfall";
		}
		...
		public void InitPanel(int contributionID, int questID)
		{
			...
			WrapperContribution item = LegionfallData.legionfallDictionary[contributionID].contribution;
		...
		public void MakeContribution()
		{
			...
			WrapperContribution item = LegionfallData.legionfallDictionary[this.m_contributionID].contribution;
			if (item.State == 1)
			{
				LegionfallBuildingPanel.s_lastContributionID = this.m_contributionID;
				Debug.Log(string.Concat("Starting to contribute to ID ", item.ContributionID));
				if (Main.instance.MakeContributionRequestInitiatedAction != null)
				{
					Main.instance.MakeContributionRequestInitiatedAction();
				}
				LegionCompanionWrapper.MakeContribution(item.ContributionID);
