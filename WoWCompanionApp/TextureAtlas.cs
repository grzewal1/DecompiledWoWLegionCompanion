...
namespace WoWCompanionApp
{
	public class TextureAtlas
	{
		...
		public static int GetUITextureAtlasMemberID(string atlasMemberName)
		{
			...
			UiTextureAtlasMemberRec recordFirstOrDefault = StaticDB.uiTextureAtlasMemberDB.GetRecordFirstOrDefault((UiTextureAtlasMemberRec rec) => (rec.CommittedName == null ? false : rec.CommittedName.Equals(atlasMemberName, StringComparison.OrdinalIgnoreCase)));
			if (recordFirstOrDefault != null)
			{
				d = recordFirstOrDefault.ID;
				TextureAtlas.instance.m_atlasMemberIDCache.Add(atlasMemberName, d);
			}
			return d;
		}
