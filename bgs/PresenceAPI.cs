...
namespace bgs
{
	public class PresenceAPI : BattleNetAPI
	{
		...
		private void DownloadCompletedCallback(byte[] data, object userContext)
		{
			...
			//    à ..( ) dans C:\DeveloperTooling_JD_Agent1\_work\15\s\OpenSource\Cecil.Decompiler\Ast\BaseCodeVisitor.cs:ligne 507
			//    à ..Visit(ICodeNode ) dans C:\DeveloperTooling_JD_Agent1\_work\15\s\OpenSource\Cecil.Decompiler\Ast\BaseCodeVisitor.cs:ligne 120
