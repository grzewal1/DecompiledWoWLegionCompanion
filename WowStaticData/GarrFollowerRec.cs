...
namespace WowStaticData
{
	public class GarrFollowerRec
	{
		...
		public int AllianceFlavorGarrStringID
		{
			get;
			private set;
		}
		...
		public uint AllianceGarrFollItemSetID
		{
			get;
			private set;
		}

		public uint AllianceGarrFollRaceID
		{
			get;
			private set;
		}
		...
		public int AllianceSourceTypeEnum
		{
			get;
			private set;
		}

		public uint AllianceUITextureKitID
		{
			get;
			private set;
		}
		...
		public int HordeFlavorGarrStringID
		{
			get;
			private set;
		}
		...
		public uint HordeGarrFollItemSetID
		{
			get;
			private set;
		}

		public uint HordeGarrFollRaceID
		{
			get;
			private set;
		}
		...
		public int HordeSourceTypeEnum
		{
			get;
			private set;
		}

		public uint HordeUITextureKitID
		{
			get;
			private set;
		}
