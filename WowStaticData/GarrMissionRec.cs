...
namespace WowStaticData
{
	public class GarrMissionRec
	{
		...
		public uint BaseCompletionChance
		{
			get;
			private set;
		}
		...
		public uint FollowerDeathChance
		{
			get;
			private set;
		}
		...
		public float Mappos_x
		{
			get;
			private set;
		}

		public float Mappos_y
		{
			get;
			private set;
		}
		...
		public uint MissionCostCurrencyTypesID
		{
			get;
			private set;
		}
		...
		public uint OfferedGarrMissionTextureID
		{
			get;
			private set;
		}
